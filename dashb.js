...
function addmgt(){
    //recuperation bl Id
    cont=document.getElementById('contcardmgt');
    taswira=document.getElementById('taswira').value;
...
function addti(){
    ...
    taswira=document.getElementById('taswirati').value;
    nom=document.getElementById('nomti').value;
    details=document.getElementById('detailsti').value;
    //nasna3 elements mte3i
    let card= document.createElement("div");
    let card_body= document.createElement("div");
    let img= document.createElement("img");
    ...
    card_body.appendChild(btn);
    //id +
    card.setAttribute("id", "newElementId");
